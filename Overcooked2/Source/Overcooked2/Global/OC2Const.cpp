...
float UOC2Const::OrderSpawnDelay = 5.0f;
...
FString UOC2Const::ChefTextureName = "ChefTexture";

FVector UOC2Const::TitleCharacterSpawnLocation = FVector(80.0f, 20.0f, 300.0f);
